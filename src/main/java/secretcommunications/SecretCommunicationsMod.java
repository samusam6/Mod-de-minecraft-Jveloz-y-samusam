...
@Mod("secret_communications")
public class SecretCommunicationsMod {
	public static final Logger LOGGER = LogManager.getLogger(SecretCommunicationsMod.class);
	public static final String MODID = "secret_communications";

	public SecretCommunicationsMod() {
		...
		SecretCommunicationsModMenus.REGISTRY.register(bus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									SecretCommunicationsMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			SecretCommunicationsMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
